...
# ═══ 传统十四主星亮度修正表 ═══
# iztro 引擎的亮度计算与经典紫微斗数有偏差（如太阴在亥=庙但引擎说陷）。
# 此表基于千年传承的星曜庙旺利陷标准，用于修正引擎输出。
# 格式：{星名: {地支: 亮度}}，只覆盖与引擎不一致或引擎不准确的位置。
_TRADITIONAL_BRIGHTNESS = {
    '紫微': {'子': '庙', '午': '庙', '丑': '旺', '未': '旺', '寅': '旺', '申': '旺', '卯': '旺', '酉': '旺', '辰': '得', '戌': '得', '巳': '得', '亥': '得'},
    '天机': {'子': '庙', '午': '庙', '寅': '旺', '申': '旺', '卯': '旺', '酉': '旺', '辰': '利', '戌': '利', '巳': '利', '亥': '利', '丑': '陷', '未': '陷'},
    '太阳': {'寅': '庙', '卯': '庙', '辰': '庙', '巳': '庙', '午': '旺', '未': '得', '申': '得', '酉': '平', '戌': '不', '亥': '陷', '子': '陷', '丑': '不'},
    '武曲': {'酉': '庙', '子': '旺', '午': '旺', '辰': '得', '戌': '得', '丑': '得', '未': '得', '寅': '利', '申': '利', '巳': '利', '亥': '利', '卯': '陷'},
    '天同': {'寅': '庙', '申': '庙', '卯': '旺', '酉': '旺', '子': '得', '午': '得', '辰': '利', '戌': '利', '巳': '利', '亥': '利', '丑': '陷', '未': '陷'},
    '廉贞': {'丑': '庙', '未': '庙', '寅': '旺', '申': '旺', '卯': '得', '酉': '得', '辰': '得', '戌': '得', '巳': '利', '亥': '利', '子': '陷', '午': '陷'},
    '天府': {'子': '庙', '午': '庙', '丑': '旺', '未': '旺', '寅': '旺', '申': '旺', '卯': '旺', '酉': '旺', '辰': '得', '戌': '得', '巳': '得', '亥': '得'},
    '太阴': {'亥': '庙', '子': '庙', '丑': '庙', '酉': '旺', '戌': '旺', '寅': '得', '申': '得', '午': '利', '未': '利', '巳': '平', '卯': '陷', '辰': '陷'},
    '贪狼': {'子': '庙', '午': '庙', '卯': '旺', '酉': '旺', '丑': '得', '未': '得', '寅': '得', '申': '得', '辰': '利', '戌': '利', '巳': '陷', '亥': '陷'},
    '巨门': {'子': '庙', '午': '庙', '丑': '平', '未': '平', '寅': '得', '申': '得', '辰': '得', '戌': '得', '巳': '利', '亥': '利', '卯': '陷', '酉': '陷'},
    '天相': {'子': '庙', '午': '庙', '寅': '旺', '申': '旺', '卯': '旺', '酉': '旺', '丑': '得', '未': '得', '辰': '得', '戌': '得', '巳': '利', '亥': '利'},
    '天梁': {'子': '庙', '午': '庙', '卯': '旺', '酉': '旺', '丑': '得', '未': '得', '辰': '利', '戌': '利', '寅': '利', '申': '利', '巳': '陷', '亥': '陷'},
    '七杀': {'子': '庙', '午': '庙', '卯': '旺', '酉': '旺', '寅': '得', '申': '得', '辰': '得', '戌': '得', '巳': '利', '亥': '利', '丑': '陷', '未': '陷'},
    '破军': {'子': '庙', '午': '庙', '丑': '旺', '未': '旺', '寅': '得', '申': '得', '辰': '得', '戌': '得', '巳': '利', '亥': '利', '卯': '陷', '酉': '陷'},
}
...
def ziwei_paipan(year: int, month: int, day: int, hour: int, minute: int = 0,
    ...
    # ═══ 亮度修正：用传统十四主星庙旺利陷表覆盖 iztro 引擎偏差 ═══
    for pal in palaces:
        branch = pal['earthly_branch']
        for s in pal['major_stars']:
            star_name = s.get('name', '')
            if star_name in _TRADITIONAL_BRIGHTNESS and branch in _TRADITIONAL_BRIGHTNESS[star_name]:
                trad_b = _TRADITIONAL_BRIGHTNESS[star_name][branch]
                iztro_b = s.get('brightness', '')
                if iztro_b != trad_b:
                    s['brightness'] = trad_b
                    s['brightness_css'] = {'庙': 'b-miao', '旺': 'b-wang', '得': 'b-de', '利': 'b-li', '平': 'b-ping', '不': 'b-bu', '陷': 'b-xian'}.get(trad_b, '')
